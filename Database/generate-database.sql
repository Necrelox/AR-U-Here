...
-- -----------------------------------------------------
-- Table `ArUHere`.`USER_FRIEND`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ArUHere`.`USER_FRIEND` ;

CREATE TABLE IF NOT EXISTS `ArUHere`.`USER_FRIEND` (
  `createdAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- -----------------------------------------------------
-- Table `ArUHere`.`USER_FRIEND_REQUESTS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ArUHere`.`USER_FRIEND_REQUESTS` ;

CREATE TABLE IF NOT EXISTS `ArUHere`.`USER_FRIEND_REQUESTS` (
  `createdAt` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
